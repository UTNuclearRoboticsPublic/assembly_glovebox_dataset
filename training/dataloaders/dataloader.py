...
if __name__ == "__main__":
    ...
    dataset = AssemblyDataset(path_to_1_labels=['./Dataset/Annotations/Test_Subject_1/By_1/id/Jenga_task/Side_View'], 
                              ...
                              img_size=161)
    # dataset = AssemblyDataset(path_to_1_labels=['/home/slwanna/assembly_glovebox_dataset/Dataset/Annotations/Test_Subject_1/By_1/id/Jenga_task/Side_View'], 
    #                         path_to_2_labels=['/home/slwanna/assembly_glovebox_dataset/Dataset/Annotations/Test_Subject_1/By_2/id/Jenga_task/Side_View'],
    #                         path_to_images=['/home/slwanna/assembly_glovebox_dataset/Dataset/Sampled_Frames/Test_Subject_1/id/Jenga_task/Side_View'],
    #                         img_size=161)
