...
from transfer_learning.tl_dataloaders.HRC_dataloader import ZL
...
class HRCDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage=="fit":
            ...
            self.train_set, self.valid_set = train_set, valid_set #random_split(train_set, [train_set_size, 
            #valid_set_size])
