...
class BinAssemblyDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        if stage=="fit":
            ...
            # swap these lengths in the array below
            self.train_set, self.valid_set = random_split(train_set, [valid_set_size, train_set_size])
    ...
    def _get_files(self, query):
        ...
        SELMA_IMG_PREFIX_PATH = "/home/slwanna/assembly_glovebox_dataset/Dataset/Sampled_Frames"
        SELMA_LABEL_PREFIX_PATH = "/home/slwanna/assembly_glovebox_dataset/Dataset/Annotations"
