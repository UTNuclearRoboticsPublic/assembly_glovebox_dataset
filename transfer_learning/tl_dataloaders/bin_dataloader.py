...
class BinAssemblyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask_1_bin = mask_1[1,:,:] + mask_1[2,:,:]
        mask_2_bin = mask_2[1,:,:] + mask_2[2,:,:]
        ...
        mask_1 = mask_1_bin # mask_to_2D(mask_1)
        mask_2 = mask_2_bin # mask_to_2D(mask_2)

        # print(f"unique in mask_1 is {torch.unique(mask_1)}")
        # print(f"unique in mask_2 is {torch.unique(mask_2)}")
...
if __name__ == "__main__":
    ...
    dataset = BinAssemblyDataset(path_to_1_labels=['/home/slwanna/FIRETEAM/Data/HAGS/FINAL_ANNOTATIONS/Test_Subject_1/By_1/id/J/Side_View'], 
                              path_to_2_labels=['/home/slwanna/FIRETEAM/Data/HAGS/FINAL_ANNOTATIONS/Test_Subject_1/By_2/id/J/Side_View'],
                              path_to_images=['/home/slwanna/FIRETEAM/Data/HAGS/FINAL_SAMPLED_FRAMES/Test_Subject_1/id/J/Side_View'],
                              img_size=161)

    dataloader = DataLoader(dataset=dataset, batch_size=1, shuffle=True)
    # print(f"hi there")
    for i, (images, masks) in enumerate(dataloader):
        # print(f"in a loop there")
